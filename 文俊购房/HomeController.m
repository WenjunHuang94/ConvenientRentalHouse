...
#import "renterInfoCityCell.h"//求租信息--cell
#import "NormalTableViewCell.h"//Root--Cell

#import "SelectCityViewController.h"//选择城市
#import "HomeDetailViewController.h"//房屋详情


@interface HomeController()<UITableViewDelegate,UITableViewDataSource,SelectCityViewControllerDelegate,CFDropDownMenuViewDelegate>

@property (nonatomic,strong)UITableView *tableView;
@property (nonatomic,strong)NSArray *dataArr;//房屋数组
...
- (void)viewDidLoad {
    ...
    [self setNavTitle:@"租房信息" AndImg:nil];
    [self setNavLeftBtnWithTitle:nil OrImage:@[@"返回"]];
    
    __weak HomeController *obj = self;
...
-(void)getData{
    ...
    [query whereKey:@"homeVerify" equalTo:@(YES)]; //查询 boolean 值时,正确方法为@(YES)
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    AVObject *home = self.dataArr[indexPath.section-1];
