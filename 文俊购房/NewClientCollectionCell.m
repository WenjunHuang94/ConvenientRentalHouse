...
#import "NewClientCollectionCell.h"

@implementation NewClientCollectionCell
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self = [super initWithFrame:frame]) {
        ...
        [_imageView setImage:[UIImage imageNamed:@"默认头像"]];
        
        _cityLabel = [UILabel new];//添加标签
