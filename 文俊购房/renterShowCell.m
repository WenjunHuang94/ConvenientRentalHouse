...
#import "renterShowCell.h"

@implementation renterShowCell

-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        
        //租金标签
        _rentMoenyLabel = [[UILabel alloc]initWithFrame:(CGRect){20,10,40,20}];
        ...
        //房型标签
        _roomLabel = [[UILabel alloc]initWithFrame:(CGRect){20,CGRectGetMaxY(_rentMoenyLabel.frame) + 5,40,20}];
        ...
        //面积标签
        _areaLabl = [[UILabel alloc]initWithFrame:(CGRect){20,CGRectGetMaxY(_roomLabel.frame) + 5,40,20}];
        ...
        //装修标签
        _propertyTypeLabel = [[UILabel alloc]initWithFrame:(CGRect){k_w - 130,CGRectGetMinY(_roomLabel.frame),40,20}];
